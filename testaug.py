"""Use the following command first before running: pip install git+https://github.com/okankop/vidaug"""
...
def load_batch(batch_idx):
    ...
    image_folder = r"D:\BCIT\ISSP\yolo\ultralytics-main\data\images"  # replace with your actual folder path to the images you want to augment
